...
namespace VentiCola.UI.Bindings
{
    public static class UGUITextBindingBuilder
    {
        ...
        public static Text fontSize(this Text self, Func<Text, int> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_FontSizeGetter, s_FontSizeSetter, value);
            return self;
        }

        public static Text fontSize(this Text self, Func<Text, int> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_FontSizeGetter, s_FontSizeSetter, value, in transitionConfig);
            return self;
        }

        public static Text fontSize(this Text self, Func<Text, int> value, SharedValue<TransitionConfig> transitionConfig)
        {
