...
namespace VentiCola.UI.Bindings
{
    public static class UGUIGraphicBindingBuilder
    {
        ...
        public static Graphic color(this Graphic self, Func<Color> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_ColorGetter, s_ColorSetter, value);
            return self;
        }

        public static Graphic color(this Graphic self, Func<Color> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_ColorGetter, s_ColorSetter, value, in transitionConfig);
            return self;
        }

        public static Graphic color(this Graphic self, Func<Color> value, SharedValue<TransitionConfig> transitionConfig)
        {
