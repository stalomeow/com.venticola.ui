...
namespace VentiCola.UI.Bindings
{
    public static class TransformBindingBuilder
    {
        ...
        public static Transform rotation(this Transform self, Func<Quaternion> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_RotationGetter, s_RotationSetter, value);
            return self;
        }

        public static Transform rotation(this Transform self, Func<Quaternion> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_RotationGetter, s_RotationSetter, value, in transitionConfig);
            return self;
        }

        public static Transform rotation(this Transform self, Func<Quaternion> value, SharedValue<TransitionConfig> transitionConfig)
        {
        ...
        public static Transform localPosition(this Transform self, Func<Vector3> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalPositionGetter, s_LocalPositionSetter, value);
            return self;
        }

        public static Transform localPosition(this Transform self, Func<Vector3> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalPositionGetter, s_LocalPositionSetter, value, in transitionConfig);
            return self;
        }

        public static Transform localPosition(this Transform self, Func<Vector3> value, SharedValue<TransitionConfig> transitionConfig)
        {
        ...
        public static Transform localRotation(this Transform self, Func<Quaternion> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalRotationGetter, s_LocalRotationSetter, value);
            return self;
        }

        public static Transform localRotation(this Transform self, Func<Quaternion> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalRotationGetter, s_LocalRotationSetter, value, in transitionConfig);
            return self;
        }

        public static Transform localRotation(this Transform self, Func<Quaternion> value, SharedValue<TransitionConfig> transitionConfig)
        {
        ...
        public static Transform localScale(this Transform self, Func<Vector3> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalScaleGetter, s_LocalScaleSetter, value);
            return self;
        }

        public static Transform localScale(this Transform self, Func<Vector3> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_LocalScaleGetter, s_LocalScaleSetter, value, in transitionConfig);
            return self;
        }

        public static Transform localScale(this Transform self, Func<Vector3> value, SharedValue<TransitionConfig> transitionConfig)
        {
