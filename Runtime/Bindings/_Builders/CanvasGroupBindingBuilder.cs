...
namespace VentiCola.UI.Bindings
{
    public static class CanvasGroupBindingBuilder
    {
        ...
        public static CanvasGroup alpha(this CanvasGroup self, Func<CanvasGroup, float> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_AlphaGetter, s_AlphaSetter, value);
            return self;
        }

        public static CanvasGroup alpha(this CanvasGroup self, Func<CanvasGroup, float> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_AlphaGetter, s_AlphaSetter, value, in transitionConfig);
            return self;
        }

        public static CanvasGroup alpha(this CanvasGroup self, Func<CanvasGroup, float> value, SharedValue<TransitionConfig> transitionConfig)
        {
