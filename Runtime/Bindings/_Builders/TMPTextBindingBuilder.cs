...
namespace VentiCola.UI.Bindings
{
    public static class TMPTextBindingBuilder
    {
        ...
        public static Text fontSize(this Text self, Func<float> value)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_FontSizeGetter, s_FontSizeSetter, value);
            return self;
        }

        public static Text fontSize(this Text self, Func<float> value, in TransitionConfig transitionConfig)
        {
            BindingUtility.BindComponentValue(self.gameObject, s_FontSizeGetter, s_FontSizeSetter, value, in transitionConfig);
            return self;
        }

        public static Text fontSize(this Text self, Func<float> value, SharedValue<TransitionConfig> transitionConfig)
        {
