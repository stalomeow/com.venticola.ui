...
namespace VentiCola.UI.Transitions
{
    ...
    public struct EasingCurve
    {
        ...
        /// 获取缓动曲线的类型
        /// </summary>
        public EasingCurveType CurveType
        {
            get => m_Type;
        }
        ...
        public float Evaluate(float t) => m_Type switch
        {
            ...
            EasingCurveType.CubicBezier => EasingUtility.CubicBezier(m_ControlPoint1, m_ControlPoint2, t),
